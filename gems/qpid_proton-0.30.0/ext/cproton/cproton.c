...
SWIGEXPORT void Init_cproton(void) {
  ...
  rb_define_const(mCproton, "PN_SSL_CERT_SUBJECT_COUNTRY_NAME", SWIG_From_int((int)(PN_SSL_CERT_SUBJECT_COUNTRY_NAME)));
  rb_define_const(mCproton, "PN_SSL_CERT_SUBJECT_STATE_OR_PROVINCE", SWIG_From_int((int)(PN_SSL_CERT_SUBJECT_STATE_OR_PROVINCE)));
  rb_define_const(mCproton, "PN_SSL_CERT_SUBJECT_CITY_OR_LOCALITY", SWIG_From_int((int)(PN_SSL_CERT_SUBJECT_CITY_OR_LOCALITY)));
  rb_define_const(mCproton, "PN_SSL_CERT_SUBJECT_ORGANIZATION_NAME", SWIG_From_int((int)(PN_SSL_CERT_SUBJECT_ORGANIZATION_NAME)));
  rb_define_const(mCproton, "PN_SSL_CERT_SUBJECT_ORGANIZATION_UNIT", SWIG_From_int((int)(PN_SSL_CERT_SUBJECT_ORGANIZATION_UNIT)));
  rb_define_const(mCproton, "PN_SSL_CERT_SUBJECT_COMMON_NAME", SWIG_From_int((int)(PN_SSL_CERT_SUBJECT_COMMON_NAME)));
  rb_define_const(mCproton, "PN_SSL_SHA1", SWIG_From_int((int)(PN_SSL_SHA1)));
  rb_define_const(mCproton, "PN_SSL_SHA256", SWIG_From_int((int)(PN_SSL_SHA256)));
  rb_define_const(mCproton, "PN_SSL_SHA512", SWIG_From_int((int)(PN_SSL_SHA512)));
  rb_define_const(mCproton, "PN_SSL_MD5", SWIG_From_int((int)(PN_SSL_MD5)));
  rb_define_module_function(mCproton, "pn_ssl_get_cert_fingerprint", _wrap_pn_ssl_get_cert_fingerprint, -1);
  rb_define_module_function(mCproton, "pn_ssl_get_remote_subject_subfield", _wrap_pn_ssl_get_remote_subject_subfield, -1);
  ...
  rb_define_const(mCproton, "PN_INVALID", SWIG_From_int((int)(PN_INVALID)));
