# -*- encoding: utf-8 -*-
# stub: vsphere-automation-cis 0.4.7 ruby lib

Gem::Specification.new do |s|
  s.name = "vsphere-automation-cis".freeze
  s.version = "0.4.7"
  ...
  s.date = "2020-07-14"
  s.description = "A Ruby SDK for the vSphere REST APIs (CIS)".freeze
  s.email = ["jrg@vmware.com".freeze]
  s.homepage = "https://github.com/vmware/vsphere-automation-sdk-ruby".freeze
  s.licenses = ["MIT".freeze]
  s.required_ruby_version = Gem::Requirement.new(">= 2.3".freeze)
  s.rubygems_version = "3.2.33".freeze
  s.summary = "A Ruby SDK for the vSphere REST APIs (CIS)".freeze
