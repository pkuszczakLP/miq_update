# -*- encoding: utf-8 -*-
# stub: vsphere-automation-runtime 0.4.7 ruby lib

Gem::Specification.new do |s|
  s.name = "vsphere-automation-runtime".freeze
  s.version = "0.4.7"
