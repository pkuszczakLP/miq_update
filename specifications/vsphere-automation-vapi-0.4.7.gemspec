# -*- encoding: utf-8 -*-
# stub: vsphere-automation-vapi 0.4.7 ruby lib

Gem::Specification.new do |s|
  s.name = "vsphere-automation-vapi".freeze
  s.version = "0.4.7"
